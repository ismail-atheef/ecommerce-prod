...
a{
  ...
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb p-3 bg-body-secondary rounded-3 ">
      ...
      <li class="breadcrumb-item"><a href="edituser.php">Edit Users</a></li>
        ...
        if ($resultuser->num_rows > 0) {
            ...
            while($rowuser = $resultuser->fetch_assoc()) {
                ...
                <tr>
                    ...
                    <td class="text-center"><a href="deleteuser.php?id=<?= $id_user; ?>"><i class="text-danger fa-solid fa-xmark"></i></a></td>
                </tr>
            <?php }}  ?>
        </tbody>
    </table>
