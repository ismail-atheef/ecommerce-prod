...
.toast-container {
  ...
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb p-3 bg-body-secondary rounded-3 ">
      ...
      <li class="breadcrumb-item"><a href="editcategory.php">Edit Category</a></li>
...
$queryfirst = "SELECT id, name, icon FROM category";
...
if ($resultfirst->num_rows > 0) {
  ...
  while($rowfirst = $resultfirst->fetch_assoc()) {
    ...
    ?>
    <tr>
    <td><img src="./src/img/<?= $icon; ?>" width="5%"></td>
      <td><?= $name; ?></td>
      <!-- <td><!?= $categoryName; ?></td> -->
      <!-- <td><!?= $price; ?></td> -->
      <td class="text-center"><a href="deletecategory.php?id=<?= $idC; ?>"><i class="text-danger fa-solid fa-xmark"></i></a></td>
